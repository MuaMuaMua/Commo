...
- (void)loadImageFromAsset
{
    ...
    CGImageRef imageRef = CGImageCreateWithImageInRect(_asset.aspectRatioThumbnail, rect);
    UIImage * thumbScale = [UIImage imageWithCGImage:imageRef];
    self.thumbnailImageView.image = thumbScale;
...
- (void)tapCheckMark
{
    ...
    if (self.selected == NO) {
        UIAlertView * alert = [[UIAlertView alloc]initWithTitle:@"你最多只能选择九张图片" message:nil delegate:self cancelButtonTitle:nil otherButtonTitles:@"我知道了", nil];
        [alert show];
    }
